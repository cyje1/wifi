...
<body>
    ...
    <div class="form-container">
        <div class="links">
            ...
            <button type="button" onclick="updateBookmark()">수정</button>
        </div>
    </div>
    ...
    <script>
        function updateBookmark() {
            ...
            window.location.href = "http://localhost:8080/wifi_war_exploded/bookmark-group-edit-submit.jsp" +
                "?id=" + <%=id%> +"&name=" + bookmarkName + "&order=" + order;
        }
